...
**利润表（Income Statement / P&L）**：一段时期的经营成果。**毛利 = 收入 − 成本**，**净利润 = 收入 − 成本 − 费用**。核心比率：毛利率 = 毛利/收入（产品竞争力），净利率 = 净利润/收入（整体盈利）。成本=与生产直接相关；费用=期间费用等与生产不直接归集的支出。发给员工或经营者的劳动报酬可计入费用或成本；股利、利润分配不计入费用。
...
|----------------------|-------------------|
| 权利/义务发生时确认 | 实际收付时确认 |
| 企业财务报告通常采用 | 可用于简单现金账、个人账或部分小规模/税务场景 |

我国企业会计核算一般要求权责发生制。有存货时若用收付实现制，容易扭曲收入成本配比和期末存货价值，不适合作为规范财务报表基础。
...
>分录（分类记录）：用“借”和“贷”作为记账符号，来记录每一笔业务“钱从哪里来、用到哪里去”的标准化公式。
...
**折旧**：直线法、双倍余额递减等；建筑物一般直线法。折旧是**非付现费用**，通过“累计折旧”等备抵科目冲减固定资产账面价值，并在利润表确认折旧费用。
...
| 摊销 | Amortization | 无形资产、长期待摊的价值按期分摊<br>收入分期摊销（提前收了别人的钱，慢慢确认收入），费用分期摊销（提前付了别人的钱，慢慢确认为成本） |
