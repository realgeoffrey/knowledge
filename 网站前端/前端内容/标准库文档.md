...
class 类名 {  // typeof 类名 === 'function'; 类名.name === '类名'
  ...
  // constructor是静态方法，`类名.constructor`可以访问。`类名.constructor !== 类名.prototype.constructor`
...
// => ["length", "prototype", "静态方法1", "name", "静态属性1", "静态属性2", "静态属性3", "静态属性4", "静态属性5", "静态方法2"]
...
>[html2canvas](https://github.com/niklasvh/html2canvas) 使用注意：
>
