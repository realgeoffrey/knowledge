...
1. 若整数大于或等于`Math.pow(2, 53)`，则会得到不精确的数。
    ...
    >不精确的数会等于一个跳跃过的数，比如`9179200084836087807`输出的是`9179200084836088000`，因此会`9179200084836087807 === 9179200084836088000`和`'9179200084836087807' == 9179200084836088000`（用来判断不精确数是否相同）。
