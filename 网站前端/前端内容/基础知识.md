...
1. 对象
    ...
    var obj5 = new Object(1);           // 等价于：new Number(1)
    var obj6 = new Object(true);        // 等价于：new Boolean(true)
    var obj7 = new Object('str');       // 等价于：new String('str')
    var obj8 = new Object({a: 'b'});    // {a: 'b'}
