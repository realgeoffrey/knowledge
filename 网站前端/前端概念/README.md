...
2. HTTP请求简单概括流程如下：
    ...
    4.获取所有资源
        ...
        1. 若获取的是HTML代码资源，里面的JS、CSS、图片也都必须通过一个个以上完整的HTTP请求步骤进行交通。
    5. 展示

        1. 根据拿到的资源对页面进行渲染，最终呈现完整的页面。
...
2. 载入页面：
    ...
    1. 页面解析步骤
        ...
        ![浏览器渲染步骤图](./images/load-html-1.png)
