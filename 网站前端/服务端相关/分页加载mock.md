...
| 3/4 | MockAPI.io 免费版 | ✅，`search=Analyst` | ✅，`page=1` | ✅，`limit=10` | ❌ | 请求参数齐全，但响应没有 total，不能直接渲染完整分页器。 | <l>https://660d2bd96ddfa2943b33731c.mockapi.io/api/users?page=1&limit=10&search=Analyst</l> |
| 3/4 | PokéAPI | ❌ | ✅，`offset=0` | ✅，`limit=10` | ✅，body `count` | 不支持列表搜索参数，但分页和总量完整。 | <l>https://pokeapi.co/api/v2/pokemon?offset=0&limit=10</l> |
| 2.5/4 | Platzi Fake Store | ❌。但支持指定字段过滤搜索，如`title=鸿蒙` | ✅，`offset=0` | ✅，`limit=10` | ❌ | 只适合作为 offset/limit 列表加载示例。 | <l>https://api.escuelajs.co/api/v1/products?offset=0&limit=10&title=鸿蒙</l> |
