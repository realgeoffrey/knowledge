...
| 3/4 | JSONPlaceholder | 否 | 是，`_start=0` 或 `_page=1` | 是，`_limit=10` | 是，header `X-Total-Count` | 支持分页和总量，但 total 在响应头，不在 body。 | <l>https://jsonplaceholder.typicode.com/posts?_start=0&_limit=10</l><br><l>https://jsonplaceholder.typicode.com/posts?_page=1&_limit=10</l> |
...
| 2/4 | Platzi Fake Store | 否 | 是，`offset=0` | 是，`limit=10` | 否，body 为数组 | 只适合作为 offset/limit 列表加载示例。 | <l>https://api.escuelajs.co/api/v1/products?offset=0&limit=10</l> |
