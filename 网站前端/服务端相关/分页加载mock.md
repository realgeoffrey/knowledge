...
| MockAPI.io 包装版示例 | ✅，`search=Analyst` | ✅，`page=1` | ✅，`limit=10` | ✅，body `total`（按配置） | 四项都支持；当前响应是 `data + total` 包装结构。 | <l>https://61273138c2e8920017bc0b3c.mockapi.io/api/users?page=1&limit=10&search=Analyst</l> |
