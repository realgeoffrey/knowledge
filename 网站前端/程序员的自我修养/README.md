...
| <div style="white-space: nowrap;">特性维度</div> | 微服务 | 微前端 |
| :--- | :--- | :--- |
...
| 部署方式 | 每个服务可独立部署，通常与**Docker容器**和**Kubernetes**结合 | 各子应用独立构建、独立上线，主应用动态加载 |
...
| 代表技术 | Spring Cloud、Dubbo、gRPC、Kubernetes | qiankun、single-spa、webpack模块联邦（Module Federation）、Web Components |
