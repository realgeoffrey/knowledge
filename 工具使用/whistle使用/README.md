...
3. **Rules**
    ...
    1. 设置hosts、代理转发
        ...
        ```text
        # 访问 127.0.0.1 转发到 10.172.26.172
        host://10.172.26.172 127.0.0.1

        # 访问 localhost 转发到 10.172.26.172
        host://10.172.26.172 localhost

        # SwitchyOmega 的 不代理的地址列表 需要设置 <-loopback> 才能代理 127.0.0.1 和 localhost
        # 手机浏览器暂时没有找到能代理 127.0.0.1 和 localhost 的方式
        ```
    2. 代理转发
